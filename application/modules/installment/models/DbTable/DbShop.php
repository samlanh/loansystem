...
class Installment_Model_DbTable_DbShop extends Zend_Db_Table_Abstract
{

    protected $_name = 'ln_lns_shop';
    function addShop($_data){
    	try{
	    	...
	    	$_arr = array(
	    			...
	    			'shop_namekh'=>$_data['branch_namekh'],
	    			'shop_nameen'=>$_data['branch_nameen'],
    ...
    public function updateBranch($_data,$id){
    	try{
	    	...
	    	$where=$this->getAdapter()->quoteInto("shop_id=?", $id);
    ...
    function getAllShop($search=null){
    	$db = $this->getAdapter();
    	$sql = "SELECT b.shop_id,b.shop_namekh,b.shop_nameen,b.prefix,
				 b.branch_code,b.br_address,b.branch_tel,b.other ";
    	
    	$dbp = new Application_Model_DbTable_DbGlobal();
    	$sql.=$dbp->caseStatusShowImage("b.`status`");
    	$sql.=" FROM ln_lns_shop AS b ";
    	
    	$where = ' WHERE b.shop_namekh!=""';
    	...
    	if(!empty($search['adv_search'])){
    		...
    		$s_where[]=" REPLACE(b.shop_namekh,' ','')  	LIKE '%{$s_search}%'";
    		$s_where[]=" REPLACE(b.shop_nameen,' ','')  	LIKE '%{$s_search}%'";
    	...
    	$dbp = new Application_Model_DbTable_DbGlobal();
    	$where.=$dbp->getAccessPermission("shop_id");
    	
    	$order=' ORDER BY b.shop_id DESC';
 	    return $db->fetchAll($sql.$where.$order);
    }
    
 	function getShopbyId($id){
    	$db = $this->getAdapter();
    	$sql = "SELECT * FROM ln_lns_shop WHERE `shop_id`= $id" ;
   		return $db->fetchRow($sql);
    }
    public static function getBranchCode(){
    	$db = new Application_Model_DbTable_DbGlobal();
    	$sql = "SELECT COUNT(shop_id) AS amount FROM `ln_lns_shop`";
