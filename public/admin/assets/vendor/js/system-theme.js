!function(t, e) {
    ...
    return function() {
        ...
        var t = {
            7621: function(t, e, i) {
                var s = i(8081)
                  ...
                  , u = o()(a())
                  , d = l()(c);
                u.push([t.id, '#system-theme-skin{font-family:inherit;font-size:inherit !important;position:fixed;top:0;right:0;height:100%;z-index:99999999;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;width:400px;background:#fff;-webkit-box-shadow:0 0 20px 0 rgba(0,0,0,.2);box-shadow:0 0 20px 0 rgba(0,0,0,.2);-webkit-transition:all .2s ease-in;-o-transition:all .2s ease-in;transition:all .2s ease-in;-webkit-transform:translateX(420px);-ms-transform:translateX(420px);transform:translateX(420px)}#system-theme-skin h5{position:relative;font-size:11px}#system-theme-skin>h5{flex:0 0 auto}#system-theme-skin .disabled{color:#d1d2d3 !important}#system-theme-skin .form-label{font-size:.9375rem}#system-theme-skin .form-check-label{font-size:.8125rem}#system-theme-skin .system-theme-skin-t-panel_header{font-size:1.125rem}#system-theme-skin.system-theme-skin-open{-webkit-transition-delay:.1s;-o-transition-delay:.1s;transition-delay:.1s;-webkit-transform:none !important;-ms-transform:none !important;transform:none !important}#system-theme-skin.system-theme-skin-open .custom-option.checked{color:var(--bs-primary);border-width:2px}#system-theme-skin.system-theme-skin-open .custom-option.checked .custom-option-content{border:none}#system-theme-skin.system-theme-skin-open .custom-option .custom-option-content{border:1px solid rgba(0,0,0,0)}#system-theme-skin .system-theme-skin-header a:hover{color:inherit !important}#system-theme-skin .system-theme-skin-open-btn{position:absolute;top:180px;left:0;z-index:-1;display:block;width:42px;height:42px;border-top-left-radius:15%;border-bottom-left-radius:15%;background:var(--bs-primary);color:#fff !important;text-align:center;font-size:18px !important;line-height:42px;opacity:1;-webkit-transition:all .1s linear .2s;-o-transition:all .1s linear .2s;transition:all .1s linear .2s;-webkit-transform:translateX(-62px);-ms-transform:translateX(-62px);transform:translateX(-62px)}@media(max-width: 991.98px){#system-theme-skin .system-theme-skin-open-btn{top:145px}}.dark-style #system-theme-skin .system-theme-skin-open-btn{background:var(--bs-primary)}#system-theme-skin .system-theme-skin-open-btn::before{content:"";width:22px;height:22px;display:block;background-size:100% 100%;position:absolute;background-image:url(' + d + ');margin:10px}.customizer-hide #system-theme-skin .system-theme-skin-open-btn{display:none}[dir=rtl] #system-theme-skin .system-theme-skin-open-btn{border-radius:0;border-top-right-radius:15%;border-bottom-right-radius:15%}[dir=rtl] #system-theme-skin .system-theme-skin-open-btn::before{margin-left:-2px}#system-theme-skin.system-theme-skin-open .system-theme-skin-open-btn{opacity:0;-webkit-transition-delay:0s;-o-transition-delay:0s;transition-delay:0s;-webkit-transform:none !important;-ms-transform:none !important;transform:none !important}#system-theme-skin .system-theme-skin-inner{position:relative;overflow:auto;-webkit-box-flex:0;-ms-flex:0 1 auto;flex:0 1 auto;opacity:1;-webkit-transition:opacity .2s;-o-transition:opacity .2s;transition:opacity .2s}#system-theme-skin .system-theme-skin-inner>div:first-child>hr:first-of-type{display:none !important}#system-theme-skin .system-theme-skin-inner>div:first-child>h5:first-of-type{padding-top:0 !important}#system-theme-skin .system-theme-skin-themes-inner{position:relative;opacity:1;-webkit-transition:opacity .2s;-o-transition:opacity .2s;transition:opacity .2s}#system-theme-skin .system-theme-skin-theme-item{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;align-items:center;-ms-flex-align:center;-webkit-box-flex:1;-ms-flex:1 1 100%;flex:1 1 100%;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;margin-bottom:10px;padding:0 24px;width:100%;cursor:pointer}#system-theme-skin .system-theme-skin-theme-item input{position:absolute;z-index:-1;opacity:0}#system-theme-skin .system-theme-skin-theme-item input~span{opacity:.25;-webkit-transition:all .2s;-o-transition:all .2s;transition:all .2s}#system-theme-skin .system-theme-skin-theme-item .system-theme-skin-theme-checkmark{display:inline-block;width:6px;height:12px;border-right:1px solid;border-bottom:1px solid;opacity:0;-webkit-transition:all .2s;-o-transition:all .2s;transition:all .2s;-webkit-transform:rotate(45deg);-ms-transform:rotate(45deg);transform:rotate(45deg)}[dir=rtl] #system-theme-skin .system-theme-skin-theme-item .system-theme-skin-theme-checkmark{border-right:none;border-left:1px solid;-webkit-transform:rotate(-45deg);-ms-transform:rotate(-45deg);transform:rotate(-45deg)}#system-theme-skin .system-theme-skin-theme-item input:checked:not([disabled])~span,#system-theme-skin .system-theme-skin-theme-item:hover input:not([disabled])~span{opacity:1}#system-theme-skin .system-theme-skin-theme-item input:checked:not([disabled])~span .system-theme-skin-theme-checkmark{opacity:1}#system-theme-skin .system-theme-skin-theme-colors span{display:block;margin:0 1px;width:10px;height:10px;border-radius:50%;-webkit-box-shadow:0 0 0 1px rgba(0,0,0,.1) inset;box-shadow:0 0 0 1px rgba(0,0,0,.1) inset}#system-theme-skin.system-theme-skin-loading .system-theme-skin-inner,#system-theme-skin.system-theme-skin-loading-theme .system-theme-skin-themes-inner{opacity:.2}#system-theme-skin.system-theme-skin-loading .system-theme-skin-inner::after,#system-theme-skin.system-theme-skin-loading-theme .system-theme-skin-themes-inner::after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;z-index:999;display:block}@media(max-width: 1200px){#system-theme-skin{display:none;visibility:hidden !important}}@media(max-width: 575.98px){#system-theme-skin{width:300px;-webkit-transform:translateX(320px);-ms-transform:translateX(320px);transform:translateX(320px)}}.layout-menu-100vh #system-theme-skin{height:100vh}[dir=rtl] #system-theme-skin{right:auto;left:0;-webkit-transform:translateX(-420px);-ms-transform:translateX(-420px);transform:translateX(-420px)}[dir=rtl] #system-theme-skin .system-theme-skin-open-btn{right:0;left:auto;-webkit-transform:translateX(62px);-ms-transform:translateX(62px);transform:translateX(62px)}[dir=rtl] #system-theme-skin .system-theme-skin-close-btn{right:auto;left:0}#system-theme-skin .system-theme-skin-layouts-options[disabled]{opacity:.5;pointer-events:none}[dir=rtl] .system-theme-skin-t-style_switch_light{padding-right:0 !important}', ""]),
                e.Z = u
            },
            3645: function(t) {
        ...
        return function() {
              ...
              , E = function() {
                ...
                i = [{
                    ...
                    value: function(t) {
                        ...
                        if (this._hasControls("themes")) {
                            ...
                            if (s) {
                                ...
                                n = r,
                                o = document.querySelector(".system-theme-skin-theme-css"),
                    ...
                    value: function(e) {
                        ...
                        if (e !== this.settings.lang || a) {
                            ...
                            ["panel_header", "panel_sub_header", "theming_header", "style_label", "style_switch_light", "style_switch_dark", "layout_header", "layout_label", "layout_header_label", "content_label", "layout_static", "layout_offcanvas", "layout_fixed", "layout_fixed_offcanvas", "layout_dd_open_label", "layout_navbar_label", "layout_footer_label", "misc_header", "theme_label", "direction_label"].forEach((function(t) {
                                var e = i.container.querySelector(".system-theme-skin-t-".concat(t));
                                e && (e.textContent = n[t])
                            }
                            ));
                            for (var o = n.themes || {}, r = this.container.querySelectorAll(".system-theme-skin-theme-item") || [], l = 0, c = r.length; l < c; l++) {
                                var u = r[l].querySelector('input[type="radio"]').value;
                                r[l].querySelector(".system-theme-skin-theme-name").textContent = o[u] || this._getThemeByName(u).title
                            }
                    ...
                    value: function() {
                        if (!this._ssr) {
                            ...
                            ["Theme", "Style", "LayoutCollapsed", "FixedNavbarOption", "LayoutType", "contentLayout", "Rtl", "Lang"].forEach((function(e) {
                                var i = "systemThemeCustomizer-".concat(t, "--").concat(e);
                    ...
                    value: function() {
                        ...
                        this._cleanup(),
                        this.container = this._getElementFromString('<div id="system-theme-skin" class="invert-bg-white">  <div class="p-4 m-0 lh-1 system-theme-skin-header border-bottom  position-relative py-3"> <h4 class="system-theme-skin-t-panel_header mb-2"></h4>  <div class="d-flex align-items-center gap-2 position-absolute end-0 top-0 mt-4 me-3"> <a href="javascript:void(0)" class="system-theme-skin-reset-btn text-body" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Reset Style"><i class="ti ti-refresh ti-sm"></i></a> <a href="javascript:void(0)" class="system-theme-skin-close-btn fw-light text-body" tabindex="-1" title="Close"><i class="ti ti-x ti-sm"></i></a> </div> </div> <div class="system-theme-skin-inner pt-4"> <div class="system-theme-skin-theming"> <h5 class="m-0 px-4 py-4 lh-1 d-block"> <span class="system-theme-skin-t-theming_header bg-label-primary rounded-1 py-1 px-2 fs-big"></span> </h5> <div class="m-0 px-4 pb-3 pt-1 system-theme-skin-style w-100"> <label for="customizerStyle" class="form-label d-block system-theme-skin-t-style_label"></label> <div class="row px-1 system-theme-skin-styles-options"></div> </div> <div class="m-0 px-4 pt-3 system-theme-skin-themes w-100"> <label for="customizerTheme" class="form-label system-theme-skin-t-theme_label"></label> <div class="row px-1 system-theme-skin-themes-options"></div> </div> </div> <div class="system-theme-skin-layout"> <hr class="m-0 px-4 my-4"/> <h5 class="m-0 px-4 pb-4 pt-2 d-block"> <span class="system-theme-skin-t-layout_header bg-label-primary rounded-1 py-1 px-2 fs-big"></span> </h5> <div class="m-0 px-4 pb-3 d-block system-theme-skin-layouts"> <label for="customizerStyle" class="form-label d-block system-theme-skin-t-layout_label"></label> <div class="row px-1 system-theme-skin-layouts-options"> </div> </div> <div class="m-0 px-4 pb-3 system-theme-skin-headerOptions w-100"> <label for="customizerHeader" class="form-label system-theme-skin-t-layout_header_label"></label> <div class="row px-1 system-theme-skin-header-options"></div> </div> <div class="m-0 px-4 pb-3 system-theme-skin-layoutNavbarOptions w-100"> <label for="customizerNavbar" class="form-label system-theme-skin-t-layout_navbar_label"></label> <div class="row px-1 system-theme-skin-navbar-options"></div> </div>   </div> </div> </div> ');
                        var s = this.container;
                        this.settings.displayCustomizer ? s.setAttribute("style", "visibility: visible") : s.setAttribute("style", "visibility: hidden");
                        
						setTimeout(function () {
							var a = document.getElementById("systemModeClick").querySelector(".system-theme-skin-open-btn")
							  , n = function() {
								t.container.classList.add("system-theme-skin-open"),
								t.update(),
                        ...
                        var o = this.container.querySelector(".system-theme-skin-reset-btn")
                          , r = function() {
                            t.clearLocalStorage(),
                            window.location.reload()
                        };
                        ...
                        var l = this.container.querySelector(".system-theme-skin-close-btn")
                          , c = function() {
                            t.container.classList.remove("system-theme-skin-open"),
                            t._updateInterval && (clearInterval(t._updateInterval),
                            t._updateInterval = null)
                        };
                        l.addEventListener("click", c),
                        this._listeners.push([l, "click", c]);
                        var u = this.container.querySelector(".system-theme-skin-style")
                          , d = u.querySelector(".system-theme-skin-styles-options");
                        ...
                        var h = this.container.querySelector(".system-theme-skin-themes")
                          , p = h.querySelector(".system-theme-skin-themes-options");
                        if (this._hasControls("themes")) {
                        ...
                        if (this._hasControls("rtl headerType contentLayout layoutCollapsed layoutNavbarOptions", !0)) {
                            ...
                            var N = this.container.querySelector(".system-theme-skin-layouts");
                            if (this._hasControls("layoutCollapsed")) {
                                setTimeout((function() {
                                    document.querySelector(".layout-menu-horizontal") && N.parentNode.removeChild(N)
                                }
                                ), 100);
                                var A = N.querySelector(".system-theme-skin-layouts-options");
                            ...
                            var E = this.container.querySelector(".system-theme-skin-layoutNavbarOptions");
                            if (this._hasControls("layoutNavbarOptions")) {
                                setTimeout((function() {
                                    x.includes("horizontal") && E.parentNode.removeChild(E)
                                }
                                ), 100);
                                var I = E.querySelector(".system-theme-skin-navbar-options");
                        ...
                        setTimeout((function() {
                            var e = t.container.querySelector(".system-theme-skin-layout");
                    ...
                    value: function() {
                        if (this._hasControls("style")) {
                            ...
                            this._insertStylesheet("system-theme-skin-core-css", this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace("%name%", "core".concat("light" !== t ? "-".concat(t) : "")))),
                    ...
                    value: function() {
                        if (this._hasControls("themes"))
                            this._insertStylesheet("system-theme-skin-theme-css", this.pathResolver(this.settings.themesPath + this.settings.cssFilenamePattern.replace("%name%", this.settings.theme.name + ("light" !== this.settings.style ? "-".concat(this.settings.style) : ""))));
                        else {
                            var t = this._getSetting("Theme");
                            this._insertStylesheet("system-theme-skin-theme-css", this.pathResolver(this.settings.themesPath + this.settings.cssFilenamePattern.replace("%name%", t || this.settings.defaultTheme.name + ("light" !== this.settings.style ? "-".concat(this.settings.style) : ""))))
                        }
                    }
                }, {
                    ...
                    key: "_loadingState",
                    value: function(t, e) {
                        this.container.classList[t ? "add" : "remove"]("system-theme-skin-loading".concat(e ? "-theme" : ""))
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        try {
                            e = localStorage.getItem("systemThemeCustomizer-".concat(i, "--").concat(t))
                        } catch (t) {}
                        return String(e || "")
                    }
                }, {
                    ...
                    value: function(t, e) {
                        ...
                        try {
                            localStorage.setItem("systemThemeCustomizer-".concat(i, "--").concat(t), String(e)),
            ...
            E.LANGUAGES = {
                en: {
                    panel_header: "ការកំណត់ទម្រង់ប្រព័ន្ធ / System Mode",
                    panel_sub_header: "",
                    theming_header: "ការបង្ហាញ / Theming",
                    style_label: "ការបង្ហាញ / Appearance (Mode)",
                    theme_label: "ទម្រង់ / Themes",
                    layout_header: "ប្លង់ / Layout",
                    layout_label: "ម៉ឺនុយ / Menu",
                    layout_header_label: "Header Types",
                    content_label: "Content",
                    layout_navbar_label: "របារខាងលើ / Navbar",
